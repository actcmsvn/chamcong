...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'vn';
    ...
    function queryLocale(codeArg, available) {
        ...
        var raw = queryRawLocale(codes, available) || RAW_VN_LOCALE;
    ...
    function parseLocale(codeArg, codes, raw) {
        var merged = mergeProps([RAW_VN_LOCALE, raw], ['buttonText']);
    ...
    function buildDateEnv(settings) {
        var locale = buildLocale(settings.locale || 'vn', organizeRawLocales([]).map); // TODO: don't hardcode 'vn' everywhere
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    isOnlyButtons = false;
                    children.push(createElement("h2", { className: "fc-toolbar-title dark:text-gray-300" }, props.title));
                }
                else {
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        SimpleScrollGrid.prototype.renderChunkTd = function (sectionConfig, sectionI, microColGroupNode, chunkConfig) {
            ...
            return (createElement("td", { ref: chunkConfig.elRef },
                createElement("div", { className: "fc-scroller-harness dark:text-gray-200" + (isLiquid ? ' fc-scroller-harness-liquid' : '') },
            ...
            if (headerRowContent) {
                sections.push({
                    ...
                    chunk: {
                        ...
                        tableClassName: 'fc-col-header dark:text-gray-300',
    ...
    var TableCellTop = /** @class */ (function (_super) {
        ...
        TableCellTop.prototype.render = function () {
            ...
            var navLinkAttrs = this.context.options.navLinks
                ...
                : {};
            return (createElement(DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) { return ((innerContent || props.forceDayTop) && (createElement("div", { className: "fc-daygrid-day-top dark:text-gray-300", ref: innerElRef },
