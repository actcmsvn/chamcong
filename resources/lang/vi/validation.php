...
return [
    ...
    */
    ...
    'lte'   => [
        'numeric' => ':attribute must be less than hoặc bằng :value.',
        'file'    => ':attribute must be less than hoặc bằng :value kilobytes.',
        'string'  => ':attribute must be less than hoặc bằng :value characters.',
    ...
    'required_with_all'     => ':attribute là bắt buộc khi :values được nhập.',
    'required_without'      => ':attribute là bắt buộc khi :values không được nhập.',
    'required_without_all'  => ':attribute là bắt buộc khi không có :values được nhập.',
