<x-action-section>
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-900 dark:text-gray-300">
            {{ __('auth.If necessary, you may logout of all of your other browser sessions across all of your devices. If you feel your account has been compromised, you should also update your password.') }}
        </div>
                ...
                <div class="ml-3">
                    ...
                    <div>
                        <div class="text-xs text-gray-500">
                            ...
                            <span class="font-semibold text-green-500">{{ __('auth.This device') }}</span>
                            @else
                            {{ __('auth.Last active') }} {{ $session->last_active }}
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('auth.Logout Other Browser Sessions') }}
            </x-button>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('auth.Please enter your password to confirm you would like to logout of your other browser sessions across all of your devices.') }}
