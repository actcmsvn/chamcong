    ...
    <div class="container grid px-6 mx-auto">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <a class="hover:text-gray-800 dark:hover:text-gray-200" href="{{route('users.index')}}">{{ __('admin/menus.Users') }}</a>
                    </p>
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        @php $count['users'] = \DB::table('users')->count();@endphp
                        {!! $count['users'] !!}
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <a class="hover:text-gray-800 dark:hover:text-gray-200" href="{{route('blogs.index')}}">{{ __('admin/menus.Blog') }}</a>
                    </p>
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        @php $count['blogs'] = \DB::table('blogs')->count();@endphp
                        {!! $count['blogs'] !!}
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <a class="hover:text-gray-800 dark:hover:text-gray-200" href="{{route('categories.index')}}">{{ __('admin/menus.Category') }}</a>
                    </p>
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        @php $count['categories'] = \DB::table('categories')->count();@endphp
                        {!! $count['categories'] !!}
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                        <a class="hover:text-gray-800 dark:hover:text-gray-200" href="{{route('adminContacts.index')}}">{{ __('admin/dashboard.Pending contacts') }}</a>
                    </p>
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        @php $count['contacts'] = \DB::table('contacts')->count();@endphp
                        {!! $count['contacts'] !!}
                    </p>
                </div>
            </div>
