<x-form-section submit="updateProfileInformation">
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
            ...
            <x-label for="photo" value="{{ __('admin/users.Photo') }}" />
            ...
            <x-secondary-button class="mt-2" type="button" x-on:click.prevent="$refs.photo.click()">
                {{ __('admin/users.Select A New Photo') }}
            </x-secondary-button>
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="name" value="{{ __('admin/users.Name') }}" />
        ...
        <!-- First Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="first_name" value="{{ __('admin/users.First Name') }}" />
        ...
        <!-- Last Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="last_name" value="{{ __('admin/users.Last Name') }}" />
        ...
        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="email" value="{{ __('admin/users.Email') }}" />
