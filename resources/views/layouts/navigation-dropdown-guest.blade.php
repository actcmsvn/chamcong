<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
      <div class="container flex items-center justify-between h-full px-6 mx-auto text-green-600 dark:text-green-300">
          ...
          <ul class="flex justify-right items-center flex-shrink-0 space-x-6">
              <!-- Theme toggler -->
              <li class="flex">
              ...
              <li class="relative">
                @if (Route::has('login'))
                @auth
                  <a href="{{ url('/admin/dashboard') }}" class="text-sm text-gray-700 underline dark:text-blue-100">Dashboard</a>
                  ...
                  @else
                  <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-blue-100">Login</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-blue-100">Register</a>
                    @endif
                  @endif
                @endif
              </li>
